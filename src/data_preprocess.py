...
def main():
    ...
    train_data_gcs_path = "gs://ts-lab-bucket2/data/train/train_data.csv"
    test_data_gcs_path = "gs://ts-lab-bucket2/data/test/test_data.csv"
    normalization_stats_gcs_path = "gs://ts-lab-bucket2/scaler/normalization_stats.json"
    
    # air_quality_data = pd.read_excel(os.path.join("..", "data", "raw_data", "AirQualityUCI.xlsx"))
    gcs_train_data_path = "gs://ts-lab-bucket2/data/AirQualityUCI.xlsx"
